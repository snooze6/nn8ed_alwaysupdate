...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/support/v7/widget/be;-><init>(Landroid/support/v7/widget/Toolbar;ZII)V
.end annotation
...
.method constructor <init>(Landroid/support/v7/widget/be;)V
    ...
    iget-object v0, v0, Landroid/support/v7/widget/be;->a:Landroid/support/v7/widget/Toolbar;
    ...
    iget-object v6, v0, Landroid/support/v7/widget/be;->b:Ljava/lang/CharSequence;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/be$1;->a:Landroid/support/v7/view/menu/a;
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object p1, p0, Landroid/support/v7/widget/be$1;->b:Landroid/support/v7/widget/be;

    iget-object p1, p1, Landroid/support/v7/widget/be;->c:Landroid/view/Window$Callback;

    if-eqz p1, :cond_0

    iget-object p1, p0, Landroid/support/v7/widget/be$1;->b:Landroid/support/v7/widget/be;

    iget-boolean p1, p1, Landroid/support/v7/widget/be;->d:Z
    ...
    iget-object v1, p0, Landroid/support/v7/widget/be$1;->a:Landroid/support/v7/view/menu/a;
