...
.method private a(Landroid/graphics/drawable/Drawable;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/p;->d:Landroid/support/v7/widget/bb;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/p;->d:Landroid/support/v7/widget/bb;
    ...
    iput-boolean v2, v0, Landroid/support/v7/widget/bb;->d:Z

    iput-object v1, v0, Landroid/support/v7/widget/bb;->a:Landroid/content/res/ColorStateList;
    ...
    iput-boolean v2, v0, Landroid/support/v7/widget/bb;->c:Z

    iput-object v1, v0, Landroid/support/v7/widget/bb;->b:Landroid/graphics/PorterDuff$Mode;

    :cond_2
    iget-boolean v1, v0, Landroid/support/v7/widget/bb;->d:Z

    if-nez v1, :cond_4

    iget-boolean v1, v0, Landroid/support/v7/widget/bb;->c:Z
    ...
    invoke-static {p1, v0, v1}, Landroid/support/v7/widget/l;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bb;[I)V
...
.method private e()Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/p;->b:Landroid/support/v7/widget/bb;
...
.method public a(I)V
    ...
    invoke-static {p1}, Landroid/support/v7/widget/ak;->a(Landroid/graphics/drawable/Drawable;)V
...
.method a(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/p;->c:Landroid/support/v7/widget/bb;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/p;->c:Landroid/support/v7/widget/bb;
    ...
    iget-object p1, p0, Landroid/support/v7/widget/p;->c:Landroid/support/v7/widget/bb;
...
.method public a(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p2}, Landroid/support/v7/widget/ak;->a(Landroid/graphics/drawable/Drawable;)V

    :cond_1
    sget p2, Landroid/support/v7/a/a$j;->AppCompatImageView_tint:I

    invoke-virtual {p1, p2}, Landroid/support/v7/widget/bd;->g(I)Z
...
.method d()V
    ...
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/p;->c:Landroid/support/v7/widget/bb;
    ...
    invoke-static {v0, v1, v2}, Landroid/support/v7/widget/l;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bb;[I)V

    return-void

    :cond_2
    iget-object v1, p0, Landroid/support/v7/widget/p;->b:Landroid/support/v7/widget/bb;
