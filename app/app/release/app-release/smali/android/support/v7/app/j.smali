...
.method private a(Landroid/support/v7/view/menu/h;Z)V
    ...
    iget-object p1, p0, Landroid/support/v7/app/j;->u:Landroid/support/v7/widget/ai;
    ...
    invoke-interface {p1}, Landroid/support/v7/widget/ai;->e()Z
    ...
    invoke-interface {p1}, Landroid/support/v7/widget/ai;->g()Z
    ...
    iget-object v2, p0, Landroid/support/v7/app/j;->u:Landroid/support/v7/widget/ai;

    invoke-interface {v2}, Landroid/support/v7/widget/ai;->f()Z
    ...
    :cond_1
    iget-object p2, p0, Landroid/support/v7/app/j;->u:Landroid/support/v7/widget/ai;

    invoke-interface {p2}, Landroid/support/v7/widget/ai;->i()Z
    ...
    invoke-interface {p1}, Landroid/support/v7/widget/ai;->h()Z
...
.method private a(Landroid/support/v7/app/j$d;ILandroid/view/KeyEvent;I)Z
    ...
    iget-object p3, p0, Landroid/support/v7/app/j;->u:Landroid/support/v7/widget/ai;
...
.method private b(Landroid/support/v7/app/j$d;)Z
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v7/app/j;->u:Landroid/support/v7/widget/ai;
...
.method private b(Landroid/support/v7/app/j$d;Landroid/view/KeyEvent;)Z
    ...
    iget-object v4, p0, Landroid/support/v7/app/j;->u:Landroid/support/v7/widget/ai;
    ...
    invoke-interface {v4, v6, v7}, Landroid/support/v7/widget/ai;->a(Landroid/view/Menu;Landroid/support/v7/view/menu/o$a;)V
    ...
    invoke-interface {p1, v5, p2}, Landroid/support/v7/widget/ai;->a(Landroid/view/Menu;Landroid/support/v7/view/menu/o$a;)V
    ...
    invoke-interface {p2, v5, v0}, Landroid/support/v7/widget/ai;->a(Landroid/view/Menu;Landroid/support/v7/view/menu/o$a;)V
...
.method private e(ILandroid/view/KeyEvent;)Z
    ...
    invoke-interface {p1}, Landroid/support/v7/widget/ai;->f()Z
    ...
    invoke-interface {p1}, Landroid/support/v7/widget/ai;->i()Z
...
.method private x()Landroid/view/ViewGroup;
    ...
    iput-object v1, p0, Landroid/support/v7/app/j;->u:Landroid/support/v7/widget/ai;
    ...
    invoke-interface {v1, v3}, Landroid/support/v7/widget/ai;->setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v1, v4}, Landroid/support/v7/widget/ai;->a(I)V
    ...
    invoke-interface {v1, v3}, Landroid/support/v7/widget/ai;->a(I)V
    ...
    invoke-interface {v1, v3}, Landroid/support/v7/widget/am;->setOnFitSystemWindowsListener(Landroid/support/v7/widget/am$a;)V
    ...
    :cond_f
    invoke-static {v0}, Landroid/support/v7/widget/bj;->b(Landroid/view/View;)V
...
.method a(Landroid/support/v7/app/j$d;Z)V
    ...
    iget-object v0, p0, Landroid/support/v7/app/j;->u:Landroid/support/v7/widget/ai;
...
.method g(I)I
    ...
    invoke-static {v5, v2, v4}, Landroid/support/v7/widget/bj;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
